...
0. **`pmf` を `2` にしない。** 2026-09-05 に試して**繋がらなくなった**。`1` (disable) が正しい。
   AP は WPA2/WPA3 混在で MFPC=1・MFPR=0（PMF 対応だが必須ではない）なので、
   クライアント側が PMF を無効にしていても仕様上は繋がる。
...
詳細と経緯: [incident-2026-09-07.md](incident-2026-09-07.md)
