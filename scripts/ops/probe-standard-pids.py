...
#
# 【なぜ要るか】
# 大気圧 (0x33) を一度も問い合わせていない。生ログに現れた Mode01 の応答は
# 05/0B/0F/10/42 の5つだけで、対応PIDビットマップ (0x00/0x20/0x40/0x60) も
# 取っていない。つまり 0x33 は「非対応」ではなく「未確認」である。
#
# 大気圧が取れると燃料モデルが直る。cmd/pi-obd-meter/fuel.go は
